...
ZeroFieldsBase::_Helpers::_Helpers() = default;

void ZeroFieldsBase::_Helpers::SharedDtor(MessageLite& msg) {
  static_cast<ZeroFieldsBase&>(msg)
      ._internal_metadata_.Delete<UnknownFieldSet>();
}
...
void ZeroFieldsBase::_Helpers::InternalSwap(MessageLite& self,
