...
#undef desc
 ...
 private:
  ...
  // Constant to poison unused memory regions in ExtensionSet.
  static const bool kPoisonEmptyKeyValue;
  ...
  void set_flat_capacity(uint16_t capacity) {
    ABSL_DCHECK(!IsCompletelyEmpty());
    map_.flat->flat_capacity = capacity;
  }
