        ...
        class $unused $$Msg$ final
         ...
         private:
          ...
          struct _Helpers {
            ...
            static constexpr $Msg$::ParseTableT_ InternalGenerateParseTable_(
                const $pbi$::ClassData* $nonnull$ class_data);
            static void* $nonnull$ PlacementNew_(const void* $nonnull$,
                                                 void* $nonnull$ mem,
            ...
            PROTOBUF_ALWAYS_INLINE_NODEBUG static void SharedDtor(MessageLite& msg) {
              Super_::SharedDtor(msg);
            }
          };
       ...
       {"decl_non_simple_base",
        [&] {
          if (HasSimpleBaseClass(descriptor_, options_)) {
            p->Emit(
                R"cc(
                  PROTOBUF_ALWAYS_INLINE_NODEBUG static void SharedDtor(
                      MessageLite& self) {
                    Super_::_Helpers::SharedDtor(self);
                  }
                  PROTOBUF_ALWAYS_INLINE_NODEBUG static void InternalSwap(
                      MessageLite& self, $Msg$* $nonnull$ other) {
                    Super_::_Helpers::InternalSwap(self, other);
                  }
                )cc");
          } else {
            p->Emit(
...
void MessageGenerator::GenerateSharedConstructorCode(io::Printer* p) {
  ...
  p->Emit({{"init_impl", [&] { GenerateImplMemberInit(p, InitType::kArena); }},
          ...
          R"cc(
            ...
            inline void $Msg$::_Helpers::SharedCtor(
...
void MessageGenerator::GenerateSharedDestructorCode(io::Printer* p) {
  ...
  p->Emit(
      ...
      R"cc(
        inline void $Msg$::_Helpers::SharedDtor(MessageLite& self) {
          $Msg$& this_ = static_cast<$Msg$&>(self);
          $has_bit_consistency$;
  ...
  p->Emit(
      {
          {"ctor_body",
           [&] {
             if (HasSimpleBaseClass(descriptor_, options_)) return;
             p->Emit(R"cc(_Helpers::SharedCtor(*this, arena);)cc");
             switch (NeedsArenaDestructor()) {
               case ArenaDtorNeeds::kRequired: {
                 p->Emit(R"cc(
                   if (arena != nullptr) {
...
void MessageGenerator::GenerateSwap(io::Printer* p) {
  ...
  p->Emit(
      R"cc(
        void $Msg$::_Helpers::InternalSwap(
...
void MessageGenerator::GenerateNewOp(io::Printer* p) const {
  ...
  if (new_op.needs_to_run_constructor) {
    p->Emit(R"cc(
      constexpr auto $Msg$::_Helpers::InternalNewImpl_() {
        return $pbi$::MessageCreator(&$Msg$::_Helpers::PlacementNew_,
...
void MessageGenerator::GenerateInternalGenerateClassData(io::Printer* p) {
  ...
  const auto custom_vtable_methods = [&] {
    if (HasGeneratedMethods(descriptor_->file(), options_) &&
      ...
      if (HasSimpleBaseClass(descriptor_, options_)) {
        ...
        p->Emit(R"cc(
          &$Msg$::_Helpers::Clear, &$Msg$::_Helpers::ByteSizeLong,
              &$Msg$::_Helpers::_InternalSerialize,
        )cc");
      }
    } else {
      p->Emit(R"cc(
  ...
  if (HasDescriptorMethods(descriptor_->file(), options_)) {
    p->Emit(
        ...
        R"cc(
          constexpr auto $Msg$::_Helpers::InternalGenerateClassData_(
              const MessageLite& prototype,
          ...
          R"cc(
            ...
            PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
                $pbi$::ClassDataFull $Msg$_class_data_ =
                    $Msg$::_Helpers::InternalGenerateClassData_(
                        $globals$._default);
    ...
    p->Emit(
        R"cc(
          ...
          const $pbi$::ClassDataLite $Msg$_class_data_ =
              $Msg$::_Helpers::InternalGenerateClassData_($globals$._default);
...
void MessageGenerator::GenerateSourceDefaultInstance(io::Printer* p) {
  ...
  p->Emit(
      R"cc(
        $Msg$::_Helpers::_Helpers() {
          //~ Requirements on `_Helpers` for constructor homing to work, along
          //~ with having no constexpr constructors.
          static_assert(!::std::is_trivial_v<$Msg$::_Helpers>);
          static_assert(!::std::is_aggregate_v<$Msg$::_Helpers>);
        }
      )cc");
  ...
  p->Emit(R"cc(
    inline void* $nonnull$ $Msg$::_Helpers::PlacementNew_(
        //~
...
#else   // !PROTOBUF_MESSAGE_GLOBALS
                MessageGlobalsBase($Msg$::_Helpers::InternalGenerateClassData_(
