...
_SUPPORTED_LABEL_FRAGMENT_FIELDS = {
    "proto_compiler": "proto_compiler",
    "proto_toolchain_for_cc": "proto_toolchain_for_cc",
    "proto_toolchain_for_java": "proto_toolchain_for_java",
    "proto_toolchain_for_javalite": "proto_toolchain_for_java_lite",
}
