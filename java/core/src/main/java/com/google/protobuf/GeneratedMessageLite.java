...
public abstract class GeneratedMessageLite<
  ...
  public interface ExtendableMessageOrBuilder<
    ...
    <ExtensionT> int getExtensionCount(ExtensionLite<MessageT, List<ExtensionT>> extension);

    /** Get the value of an extension. */
    <ExtensionT> ExtensionT getExtension(ExtensionLite<MessageT, ExtensionT> extension);

    /** Get one element of a repeated extension. */
    <ExtensionT> ExtensionT getExtension(ExtensionLite<MessageT, List<ExtensionT>> extension, int index);
  }
  ...
  public abstract static class ExtendableMessage<
    ...
    /** Check if a singular extension is present. */
    @Override
    public final <ExtensionT> boolean hasExtension(final ExtensionLite<MessageT, ExtensionT> extension) {
    ...
    /** Get the number of elements in a repeated extension. */
    @Override
    public final <ExtensionT> int getExtensionCount(
    ...
    @Override
    @SuppressWarnings("unchecked")
    public final <ExtensionT> ExtensionT getExtension(final ExtensionLite<MessageT, ExtensionT> extension) {
      GeneratedExtension<MessageT, ExtensionT> extensionLite = checkIsLite(extension);
