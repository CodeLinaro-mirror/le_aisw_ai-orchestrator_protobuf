...
public class JsonFormat {
  ...
  private static final ConcurrentHashMap<EnumDescriptor, AlternativeEnumJsonNames>
      enumJsonNamesCache = new ConcurrentHashMap<>();
    ...
    private EnumValueDescriptor parseEnum(EnumDescriptor enumDescriptor, JsonElement json)
      ...
      if (isString) {
        ...
        AlternativeEnumJsonNames enumJsonNames =
            enumJsonNamesCache.computeIfAbsent(enumDescriptor, AlternativeEnumJsonNames::create);
  ...
  private static final class AlternativeEnumJsonNames {
    private final Map<String, EnumValueDescriptor> map;

    private AlternativeEnumJsonNames(EnumDescriptor enumDescriptor) {
    ...
    Map<String, EnumValueDescriptor> map() {
      return map;
    }

    static AlternativeEnumJsonNames create(EnumDescriptor enumDescriptor) {
      return new AlternativeEnumJsonNames(enumDescriptor);
    }
  }
}
